...
For prototype, do simple deterrence: disable right click, serve images via canvas, and avoid download links. Add visible legal notice / ephemeral messaging to discourage misuse.
